...
const previousRequests = document.querySelector('#previousRequests')
...
weatherForm.addEventListener('submit', (e) => {
    ...
    fetch(url).then((response) => {
        response.json().then(({ error, location, forecast, corgi, requests }) => {
            ...
            if (error) {
                ...
                previousRequests.textContent = requests
            }
        })
